...
public class NetworkDrive
{
    ...
    //Размещает поля класса в памяти так, как написано, без возможной оптимизации
    [StructLayout(LayoutKind.Sequential)]
    //описывает параметры подключаемого сетевого устройства
