...
namespace OnlineStore
{
    public partial class frmMain : Form
    {
        ...
        private void настройкиВремениДняПереносаДоставкиToolStripMenuItem_Click(object sender, EventArgs e)
        {
            new frmSettingDayDelivery() { Text = (sender as ToolStripMenuItem).Text }.ShowDialog();
        }
    }
}
