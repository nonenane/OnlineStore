    ...
    public partial class frmListCategory : Form
    {
        ...
        private void btEdit_Click(object sender, EventArgs e)
        {
            if (dgvData.CurrentRow != null && dgvData.CurrentRow.Index != -1 && dtData != null && dtData.DefaultView.Count != 0)
            {
                ...
                if (DialogResult.OK == new frmAddCategory() { id = id, Text = "Редактировать категорию" }.ShowDialog())
                    get_data();
            }
        }
        ...
        {
            if (DialogResult.OK == new frmAddCategory() { id = 0, Text = "Добавить категорию" }.ShowDialog())
                get_data();
        }
